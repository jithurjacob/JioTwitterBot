...
api.update_with_media("jio_output.jpg", status= "@JioCare I'm done with this... ")# for AWS lamda scheduler
#while True:
#    #api.update_status("")
#    #api.update_with_media("jio_output.jpg", status= "@JioCare I'm done with this... ")
